...
namespace BKI_QLTTQuocAnh.US
{
    ...
    public class US_GD_HOC : US_Object
    {
        ...
        public void check_hoc_sinh_dang_hoc_yn(decimal ip_dc_id_hoc_sinh, decimal ip_dc_id_lop_mon, ref string op_dang_hoc_yn)
{
    CStoredProc v_obj_spr = new CStoredProc("f315_check_hs_trong_lm_dang_hoc_yn");
            v_obj_spr.addDecimalInputParam("@ip_dc_id_hoc_sinh", ip_dc_id_hoc_sinh);
            v_obj_spr.addDecimalInputParam("@ip_dc_id_lop_mon", ip_dc_id_lop_mon);

            SqlParameter v_op_ket_qua_yn = v_obj_spr.addNVarcharOutputParam("@op_dang_hoc_yn", op_dang_hoc_yn);
            v_obj_spr.ExecuteCommand(this);
            op_dang_hoc_yn = v_op_ket_qua_yn.Value.ToString();
}}
}
