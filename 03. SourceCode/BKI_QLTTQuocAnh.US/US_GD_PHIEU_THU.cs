...
namespace BKI_QLTTQuocAnh.US
{
    ...
    public class US_GD_PHIEU_THU : US_Object
    {
        ...
        #endregion
        private decimal Find_ID_So_Phieu(string ip_str_so_phieu)
        {
            decimal op_dc_id_phieu = 0;
            CStoredProc v_obj = new CStoredProc("pr_tim_id_phieu_tu_so_phieu");
            ...
            op_dc_id_phieu = CIPConvert.ToDecimal(v_id_phieu);

            return op_dc_id_phieu;
        ...
        public bool FindSoPhieuYN(string ip_str_so_phieu, ref decimal op_dc_id_phieu)
        {
            ...
            {
                //op_dc_id_phieu = Find_ID_So_Phieu(ip_str_so_phieu);
                op_dc_id_phieu = CIPConvert.ToDecimal(v_id_phieu);
                return true;
            }
        }
